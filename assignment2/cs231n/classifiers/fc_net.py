...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # X --affine--> p --relu--> h --affine--> scores --softmax--> loss
        
        p, p_cache = affine_forward(X, W1, b1)
        h, h_cache = relu_forward(p)
        ...
        dLdh, grads['W2'], grads['b2'] = affine_backward(dLdscores, scores_cache)
        dLdp = relu_backward(dLdh, h_cache)
        _, grads['W1'], grads['b1'] = affine_backward(dLdp, p_cache)
